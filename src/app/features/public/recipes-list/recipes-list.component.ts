          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <div class="grid md:grid-cols-4 gap-2">
                ...
                <label
                  class="flex items-center gap-2 cursor-pointer p-2 hover:bg-celadon rounded-lg transition text-sm"
                >
                  <input
                    type="checkbox"
                    [value]="allergen.id"
        ...
        <div class="grid md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div class="relative overflow-hidden h-48">
              ...
              <div
                class="w-full h-full bg-gradient-to-br from-celadon to-cambridge-blue flex items-center justify-center"
              >
                <lucide-icon
                  [img]="ChefHatIcon"
            ...
            <div class="p-5">
              ...
              <div class="mb-3">
                <span
                  class="bg-cambridge-blue text-white px-2 py-1 rounded-full text-xs font-medium"
                >
